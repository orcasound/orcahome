...
<h2 className={learnStyles.tex}>orcasound</h2>
      ...
      anoramic soundscape of the inlandwaters of Washington State(USA) and British Columbia(Canada)</p>
...
<p className={learnStyles.exhibit}>Learn About the Marine acoustic landscape and the hydrophone network  <br></br>by exploring these
Orcasound Exhibit screens designed for educational organizations in the Pudget Sound regions</p>
</div>
...
<Image src={organization2} alt='Marine Science Center Logo'/> </a>
</div>
