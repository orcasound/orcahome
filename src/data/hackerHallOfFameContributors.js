 ...
 * File  : hackerHallOfFameContributors.js
 * Desc  : file containing the arrays of contributors
 *       : for the hacker hall of fame page
 * */
...
// google contributors
export const googleContributors = [
  {
    name: 'Kunal Mehta',
    country: '(India)',
...
export const liveContributors = [
  ...
  },
  {
    ...
    roles: [],
    link: 'https://www.linkedin.com/in/michellebocklage/',
  },
  {
    name: 'Kristen Gillaspy',
    roles: [],
    link: 'https://kristengillaspyux.com/',
  },
  {
    name: 'Wei Li',
    roles: [],
...
export const arcatiaContributors = [
  {
    name: 'Maria Palamar',
...
export const projectManagementContributors = [
  {
    name: 'Firuze Gokce',
